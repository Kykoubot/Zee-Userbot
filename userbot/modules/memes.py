...
RUNS_STR = [
    ...
    "Aku pergi dulu",
    "Saya tidak bisa berlari, karena saya terlalu gemuk untuk lari.",
    "Saya Cape!",
    ...
    "Siapapun dapat berlari seratus meter, dan saya dapat melakukannya tanpa bernafas.",
